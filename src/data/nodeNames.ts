...
const nodeNamePairs: Record<string, NodeNamePair[]> = {
  ...
  act5: [
    { international: "林間空地", chinese: "林间空地" },
    { international: "灰燼森林", chinese: "灰烬森林" },
    { international: "庫萊亞村", chinese: "克里亚村" },
    { international: "冰川湖泊", chinese: "冰川池塘" },
    { international: "狂嗥洞穴", chinese: "嚎叫洞穴" },
    { international: "庫萊亞山巔", chinese: "克里亚峰" },
    { international: "蝕刻溪谷", chinese: "刻蚀峡谷" },
    { international: "庫阿西克寶庫", chinese: "库阿奇克宝库" },
    { international: "卡里市集", chinese: "卡莉集市" },
    { international: "卡里交匯道", chinese: "卡莉渡口" },
    { international: "卡塔爾之塘", chinese: "卡哈塔之池" },
    { international: "塞爾卡里庇護所", chinese: "塞卡莉圣所" },
    { international: "賈萊關口", chinese: "加莱之门" },
    { international: "奇瑪", chinese: "奇玛尔" },
    { international: "奇瑪水源地", chinese: "奇玛尔水库" },
    { international: "庇護所", chinese: "避难所" },
    { international: "火噬農地", chinese: "焦土农田" },
    { international: "瑟雷之石", chinese: "瑟尔之石" },
    { international: "黑木林", chinese: "黑木林" },
    { international: "霍爾登", chinese: "霍尔顿" },
    { international: "狼之要塞", chinese: "狼堡" },
    { international: "霍爾登宅第", chinese: "霍尔顿庄园" },
  ],
};
